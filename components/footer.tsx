                        ...
                        <div className="flex flex-col w-1/4 px-4">
                            ...
                            <form>
                                <div className="flex flex-row items-center">                                
                                    <input type="email" id="email" name="email" className="text-xs bg-transparent h-10 w-72 rounded-l-lg ring-1 ring-gray-500 focus:ring-amber-700 focus:outline-none px-4" placeholder="Enter email..."/>                                                                    
                                    <Button className='text-sm font-inter font-medium border border-amber-800 bg-amber-800 hover:shadow-xl hover:bg-white hover:cursor-pointer py-2.5 rounded-r-lg text-white hover:text-amber-800 tracking-wider transition duration-200 ease-in-out px-6'>Submit</Button>
                                </div>    
                            </form>
                        </div>
                    </div>
