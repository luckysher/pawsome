        ...
        <div className='flex flex-col py-10'>            
            <div className='flex flex-row justify-center'>
                <div className='flex flex-col text-center w-full sm:w-full md:w-2/3 lg:w-2/3 xl:w-2/3 2xl:w-2/3 px-5'>
                    <h1 className='font-inter font-bold text-[32px]'>Frequently Bought</h1>            
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-4 px-6 mt-15 gap-6 sm:gap-6 ">
                {
                    products.map((product, i) => (
                        <div key={i} className='flex flex-col border border-neutral-500 rounded-xl'>
                            <div className='flex flex-col p-2'>
                                <div className='flex flex-col'>
                                    <div className='flex flex-row justify-between sm:justify-between md:justify-between lg:justify-between xl:items-center 2xl:items-center'>
                                ...
                                <Button className='text-[13px] font-lato font-semibold border hover:border-amber-800 bg-amber-800 hover:shadow-xl hover:bg-white hover:cursor-pointer p-3 rounded-lg text-white hover:text-amber-800 tracking-wider transition duration-200 ease-in-out mt-4' title={"Add to cart"}>Add to Cart</Button>
                            </div>
