...
export default function SignUpPage() {
    ...
    return (
        <div className='flex justify-between px-35 py-15 items-center'>
                     ...
                     <form>                        
                        <div className="bg-white rounded-lg">
                            <div className="relative bg-inherit flex items-center text-xs mb-6 md:mb-8 ">                                
                                <input type="text" id="full_name" name="full_name" className="peer bg-transparent h-10 w-72 rounded-lg  ring-1 px-2 ring-gray-500 focus:ring-amber-700 focus:outline-none focus:border-rose-600 px-2 w-full" placeholder="e.g Adam James"/>
                        ...
                        <div className="bg-white rounded-lg">
                            <div className="relative bg-inherit flex items-center text-xs mb-6 md:mb-8 ">                                
                                <input type="text" id="phone_no" name="phone_no" className="peer bg-transparent h-10 w-72 rounded-lg  ring-1 px-2 ring-gray-500 focus:ring-amber-700 focus:outline-none focus:border-rose-600 px-2 w-full" placeholder="9821420110"/>
                        ...
                        <div className="bg-white rounded-lg">
                            <div className="relative bg-inherit flex items-center text-xs mb-6 md:mb-8 ">                                
                                <input type="text" id="email" name="email" className="peer bg-transparent h-10 w-72 rounded-lg  ring-1 px-2 ring-gray-500 focus:ring-amber-700 focus:outline-none focus:border-rose-600 px-2 w-full" placeholder="Enter Email"/>
